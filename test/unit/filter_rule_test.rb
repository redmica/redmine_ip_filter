...
class FilterRuleTest < ActiveSupport::TestCase
  ...
  def test_valid_access_returns_true_remote_ip_includes_additional_allowed_ip
    #IPFilterConfig.class_variable_set :@@config, {'additional_allowed_ip_list' => ['33.44.55.66']}
    IPFilterConfig.stubs(:'[]').with('additional_allowed_ip_list').returns(['33.44.55.66', '44.55.66.77'])
